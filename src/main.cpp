...
void predict(bool &is_car_in_lane, bool &is_car_left, bool &is_car_right){
    ...
    //       // Car in our lane.
    //       is_car_in_lane |= check_car_s > car_s && check_car_s - car_s < 30;
...
/// Initialise
            ...
            // predict(is_car_in_lane, is_car_left, is_car_right);            
            vector<double> ptsx;
            vector<double> ptsy;
//////////////////////////////// PREDICT //////////////////////////////////////////////
    ...
    for (auto other_car: sensor_fusion) {
        ...
        if ( other_car_lane == lane ) {
          // Check car 30 m forward
          if (check_car_s - car_s > 0 && check_car_s - car_s < 30)
            is_car_in_lane = true;
        } else if ( other_car_lane - lane == -1 ) {
          // Check car 30 m behind and 30 m forward
